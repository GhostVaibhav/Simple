        ...
        <div>
            <div className='relative bg-gray-50 dark:bg-gray-900 overflow-x-hidden overflow-y-hidden max-h-max flex flex-col items-center p-10'>
                ...
                <div className='absolute inset-0 p-2 grid grid-cols-12 gap-2 transform -skew-y-12 scale-150'>
                    {/* Row 1 */}
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-2 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-5 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-1 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-4 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    {/* Row 2 */}
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-5 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-3 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-2 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-2 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    {/* Row 3 */}
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-4 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-5 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-1 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-6 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    {/* Row 7 */}
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-1 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-2 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-8 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-1 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    {/* Row 8 */}
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-6 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={trans} variants={pageTransition} className='col-span-4 bg-gray-800 rounded animate-pulse' style={{ animationDelay: `${getRandomInt(delay)}s`, animationDuration: `${getRandomInt(dur)}s` }} />
