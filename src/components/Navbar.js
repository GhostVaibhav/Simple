    ...
    return (
        <div>
            ...
            <div className='sidebar border-r-gray-700 border-r-[1px] fixed md:opacity-95 h-screen bg-gray-800 top-0 left-0 z-10 transform -translate-x-full transition duration-200 ease-in-out'>
                ...
                {/* Opening button */}
                <div>
                    <button onClick={click} className='open-button transition duration-150 focus:outline-none opacity-90 backdrop-blur-xl fixed mx-0 m-2 p-4 rounded-full bg-gray-900 hover:bg-gray-700 border border-gray-700 z-10 -right-16 top-0 text-white'>
